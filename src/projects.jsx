const projects = [
  {
    ...
    demoUrl:
      "https://www.instagram.com/reel/DS8COyxDRyE/?igsh=Y2pwMjhjdnhyMmo2",
  },
  {
    id: 2,
    title: "BTS of APPSN",
    ...
    tags: ["CapCut", "Videography"],
    demoUrl:
      "https://www.instagram.com/reel/DQSLabMiN0Z/?igsh=NnpzZWU1d3BieHpj",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    tags: ["HTML", "CSS"],
    demoUrl: "https://appleclone-pearl.vercel.app/",
  },
  {
    id: 8,
    title: "THUB GADGET",
  ...
  },
  {
    ...
    tags: ["CapCut", "Videography"],
    demoUrl:
      "https://www.instagram.com/reel/DK4txCls8Kr/?igsh=MW84c2JidWZvdmxhag==",
  },
  {
    id: 10,
  ...
  },
  {
    ...
    tags: ["CapCut", "Videography"],
    demoUrl:
      "https://drive.google.com/file/d/1ISUYYMzmCV8IFlmq5v9gxqjuQY5EyyMD/view?usp=drivesdk",
  },
];
    ...
    >
      ...
      <div className="bg-gray-900 py-20">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto px-4 text-3xl font-semibold text-gray-400">
          Here are some of my recent projects that showcase my skills in mobile
          videography and frontend development.
        </p>
      </div>
